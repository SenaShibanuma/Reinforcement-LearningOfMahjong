...
class MahjongEnv:
    ...
    def _calculate_agari_result(self, player_idx, tile, is_tsumo, dora_indicators):
        ...
        config = HandConfig(
            ...
            player_wind=EAST + ((player_idx - self.game_state['oya_player_id'] + self.num_players) % self.num_players),
    ...
    def _handle_discard_phase(self, action):
        ...
        if action_type == 'ACTION' and action_parts[1] == 'RIICHI':
            ...
            self.game_state['is_ippatsu_chance'][self.current_player_idx] = True
